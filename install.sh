...
install_freeswitch ()
{
        if [ ${DIST} = "DEBIAN" ]; then
                ...
                wget -O - http://files.freeswitch.org/repo/deb/freeswitch-1.6/freeswitch_archive_g0.pub | apt-key add -
                echo "deb http://files.freeswitch.org/repo/deb/freeswitch-1.6/ stretch main" > /etc/apt/sources.list.d/freeswitch.list
                echo "deb-src http://files.freeswitch.org/repo/deb/freeswitch-1.6/ stretch main" >> /etc/apt/sources.list.d/freeswitch.list
